...
// ============================================================
// CONFIGURACIÓN DE SEGURIDAD (HASH DE CONTRASEÑA)
// ============================================================
...
function verificarSesionAdmin() {
    ...
    if (auth === 'authenticated' && loginTime) {
        ...
        if (timeElapsed < 14400000) { // 4 horas
            return true;
        } else {
...
/**
 * Verifica la sesión del validador
 */
...
/**
 * Obtiene el nombre de un archivo a partir de su URL
 */
 ...
 * @param {string} path - Ruta en Storage (ej: 'galeria/vocho/')
 ...
 * @param {Function} onProgress - Callback de progreso (archivo, progreso)
 * @returns {Promise<Array<{file: File, url: string}>>}
 */
...
/**
 * Carga un documento específico de Firestore
 * @param {string} coleccion - Nombre de la colección
...
/**
 * Guarda un documento en Firestore (crea o actualiza)
 * @param {string} coleccion - Nombre de la colección
 * @param {string} id - ID del documento (opcional, si no se crea uno nuevo)
...
// ============================================================
// FUNCIONES PARA EVITAR QUE SE CIERRE EL ADMIN
// ============================================================
...
/**
 * Carga los eventos en un select
...
/**
 * Registra un asistente desde el formulario público
 */
async function registrarAsistentePublico() {
    ...
    try {
        ...
        // Actualizar el evento con el ID del asistente
